...
public class PeticionesServiceImpl implements PeticionesService {
	...
	@Override
	public Response<Object> consultarPaginado(Map<String, Object> params, Authentication authentication)  {
	...
	@Override
	public Response<Object> actualizaDatos(Persona request, Authentication authentication) {
	...
	@Override
	public Response<Object> borrarDatos(Persona request, Authentication authentication) {
		UsuarioDto user = datosUtil.getUserData(authentication);
